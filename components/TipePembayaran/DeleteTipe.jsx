...
export default function DeleteDataTipe(data) {
  ...
  async function handleDelete(tipeID) {
    setIsMutating(true);
    await fetch(`http://localhost:3000/api/tipe_pembayaran?id=${tipeID}`, {
      method: 'DELETE',
    });
    setIsMutating(false);
    ...
    <div>
      ...
      <div className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Are you sure to delete {data.namaTipe} ?</h3>
